...
namespace Core
{
    ...
    public class Player
    {
        ...
        {
            var item = ActualRoom.VisibleObjects.Find(x => x.Name == nameOfItem);
            if (item != null)
        ...
        {
            var item = Inventory.Find(x => x.Name == name);
            if (item != null)
            {
        ...
        public void TakeFromObject(string name, IGameObject paObject)
        {
            ...
            {
                var b = (Bookshelf) paObject;
                var book = b.Books.Find(x => x.Name == name);
                if (book != null)
            ...
            {
                var c = (Chest) paObject;
                var item = c.Items.Find(x => x.Name == name);
                if (item != null)
                    if (item.Type == GameObjectType.Gold)
                    {
                        var g = (Gold) item;
                ...
                if (o != null)
                {
                    if (o.Type == GameObjectType.Chest) // check if player can look into chest
                    {
                        ...
                        if (chest.IsUnlocked)
                        {
                            if (!chest.IsClosed)
                                return o;
                            Console.WriteLine("Chest " + chest.Name + " is closed!");
                            return null;
                        }
                        Console.WriteLine("Chest " + chest.Name + " is locked!");
                        return null;
                    }
