...
namespace PotSemestralkaJakubBlunar
{
    ...
    public class Game
    {
        ...
        public void Start()
        {
            ...
            while (IsRunning)
            {
                if ((Player != null) && (Player.ActualRoom.Name == Loader.LastRoom))
                {
                    // check if player won
                    IsRunning = false;
                    ...
                    {
                        Console.WriteLine(
                            "When you got outside big dragon attacked you. With your golden_sword you beat that monster.");
                    ...
                    {
                        Console.WriteLine(
                            "When you got outside big dragon attacked you. You didn't have something to use for defense. Monster have eaten you.");
        ...
        public void Save(string paFile)
        {
            ...
            using (var file = new FileStream("./" + paFile + ".xml", FileMode.Create))
            {
                try
                {
                ...
                using (var file = new FileStream(fileName, FileMode.Open))
                {
                    ...
                    try
                    {
                        ...
                        using (var f = new StreamReader("./" + paFile))
                        {
                            try
                            {
                                var h = int.Parse(f.ReadLine());
                                var m = int.Parse(f.ReadLine());
                                var s = int.Parse(f.ReadLine());
                                var tm = new TimeSpan(h, m, s);
